...
const PLATFORMS: { name: string; color: string; initial: string; href?: string }[] = [
  ...
  { name: "Reddit", color: "from-orange-500 to-orange-600", initial: "R", href: "/reddit-video-downloader" },
  { name: "Vimeo", color: "from-sky-500 to-cyan-500", initial: "V", href: "/vimeo-video-downloader" },
  { name: "SoundCloud", color: "from-orange-400 to-amber-500", initial: "SC", href: "/soundcloud-mp3-downloader" },
  { name: "Threads", color: "from-neutral-900 to-black", initial: "TH", href: "/threads-video-downloader" },
  { name: "LinkedIn", color: "from-blue-700 to-blue-600", initial: "IN", href: "/linkedin-video-downloader" },
  { name: "Dailymotion", color: "from-sky-600 to-blue-600", initial: "DM", href: "/dailymotion-video-downloader" },
];
  ...
  return (
    <section id="platforms" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
      ...
      <p className="mx-auto mt-2 max-w-xl text-center text-sm text-neutral-600 sm:text-base dark:text-neutral-400">
        You never have to choose a platform. Paste the link, and
        PasteAndSave works out which site it came from and shows the
        quality options. These are the popular ones.
      </p>
      ...
      <p className="mt-6 text-center text-sm text-neutral-500 dark:text-neutral-400">
        Snapchat, Twitch, Bluesky, Tumblr, Bandcamp, Mixcloud, Rumble, Imgur,
        VK and Bilibili work too, along with many smaller sites.
      </p>
    </section>
  );
}
